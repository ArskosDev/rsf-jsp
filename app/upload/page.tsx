        ...
        <>
            <UploadLayout>
                <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
                    <div className=" ">
                        <h1 className="text-[23px] font-semibold" > Charger Video</h1>
                        <h2 className="text-gray-400 mt-1"> Poster une video sur votre compte</h2>
                    ...
                    <div className="mt-8 md:flex gap-6 ">
                        {!fileDisplay ?(
                            ...
                            >
                                ...
                                <p className="mt-4 text-[17px]"> Choisir la video à charger</p>
                                <p className="mt-1.5 text-gray-500 text-[13px]">Ou glisser-deposer un fichier</p>
                                <p className="mt-12 text-gray-400 text-sm">MP4</p>
                                <p className="mt-2 text-gray-400 text-[13px]">Jusqu'a 30 minutes</p>
                                <p className="mt-2 text-gray-400 text-[13px]">Moins de 2 GB</p>
                                <label 
                                    htmlFor="fileInput"
                            ...
                            >
                                ...
                                <div className="absolute -bottom-12 flex items-center justify-between z-50 rounded-xl border w-full p2 border-gray-300">
                        ...
                        <div className="mt-4 mb-6">
                            <div className="flex bg-[#F8F8F8 py-4 px-6 ">
                                ...
                                <div>
                                    <div className="text-semibold text-[15px] mb-1.5"> Couper et editer video</div>
                                    <div className="text-semibold text-[10px text-gray-400">
                                        Coupez vos videos en plusieurs parties, 
                                        supprimer ce qui vous gene et changer 
                                        les formats paysage en portrait
                            ...
                            <div className="mt-5">
                                <div className="flex items-center justify-between">
                                    <div className="mb-1 text-[15px]"> Titre </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                > 
                                    {isUploading ? <BiLoaderCircle className="anime-spin" color="#ffffff" size={25}/> : 'Publier'}
                                </button>
